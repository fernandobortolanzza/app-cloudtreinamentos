    ...
    <div class="overflow-hidden">
            ...
            <div
              ...
              <div
                ...
                <div
                  ...
                  <a
                    class="py-3 md:py-6 font-medium text-gray-600 hover:text-gray-500 focus:outline-hidden focus:text-gray-500 dark:text-neutral-400 dark:hover:text-neutral-500 dark:focus:text-neutral-500"
                    href="#"
                    aria-current="page">
                    Landing
                  </a>
                  ...
                  <div
                    ...
                    <button
                      id="hs-mega-menu-pdp"
                      type="button"
                      class="flex items-center w-full text-gray-600 hover:text-gray-400 focus:outline-hidden focus:text-gray-400 font-medium dark:text-neutral-400 dark:hover:text-neutral-500 dark:focus:text-neutral-500"
                      aria-haspopup="menu"
                      aria-expanded="false"
                    ...
                    <div
                      ...
                      <div
                        class="md:grid md:grid-cols-2 lg:grid-cols-3 gap-4">
                        <div class="flex flex-col mx-1 md:mx-0">
                          <a
                            class="group flex gap-x-5 text-gray-800 hover:bg-gray-100 focus:outline-hidden focus:bg-gray-100 rounded-lg p-4 dark:text-neutral-200 dark:hover:bg-neutral-800 dark:focus:bg-neutral-800"
                            href="#">
                            <svg
                            ...
                            <div class="grow">
                              ...
                              <p
                                class="text-sm text-gray-500 group-hover:text-gray-800 group-focus:text-gray-800 dark:text-neutral-500 dark:group-hover:text-neutral-200 dark:group-focus:text-neutral-200">
                        ...
                        <div class="flex flex-col pt-4 md:pt-0 mx-1 md:mx-0">
                          <span
                            class="text-sm font-semibold uppercase text-gray-800 dark:text-neutral-200">Customer stories</span>

                          <a
                            class="mt-4 group flex gap-x-5 items-center focus:outline-hidden"
                            href="#">
                            <img
                  ...
                  <div class="pt-3 md:pt-0">
                    <a
                      class="py-2.5 px-3 inline-flex items-center gap-x-2 text-sm font-medium rounded-lg border border-transparent bg-violet-900 text-white hover:bg-violet-700 focus:outline-hidden focus:bg-violet-700 disabled:opacity-50 disabled:pointer-events-none"
                      href="#">
                      Request demo
                    </a>
                  </div>
      ...
      <div class="relative">
        ...
        <div aria-hidden="true" class="flex -z-1 absolute -top-48 start-0">
          <div
            class="bg-purple-200 opacity-30 blur-3xl w-[1036px] h-150 dark:bg-purple-900 dark:opacity-20"></div>
          <div
            class="bg-gray-200 opacity-90 blur-3xl w-[577px] h-75 transform translate-y-32 dark:bg-neutral-800/60"></div>
        </div>
        <!-- End Gradients -->

        <div
          class="h-full px-4 pt-10 sm:px-6 lg:px-8 lg:pt-22 mx-auto">
          <!-- Title -->
          <div class="max-w-4xl mx-auto text-center mb-10 border border-gray-300 px-10 py-10">
            <h2
              class="text-3xl leading-tight font-bold md:text-4xl md:leading-tight lg:text-5xl lg:leading-tight bg-clip-text bg-linear-to-r from-violet-600 to-fuchsia-700 text-transparent">
              Aplicação  teste AWS Code Pipeline
            </h2>
            <p class="mt-0 lg:text-lg text-gray-800 dark:text-neutral-200">
              versão 1.0
            </p>
            <h1 class="mt-10 text-4xl font-bold text-gray-800 text-center">
              Dados instancia
            </h1>
            <h3
            ...
            <h1 class="text-4xl font-bold text-gray-800 text-center">
              Simulador alta carga CPU
            </h1>
            <?php 
              if (!empty($message)) echo '<p class="text-3xl leading-tight font-bold md:text-4xl md:leading-tight lg:text-2xl lg:leading-tight bg-clip-text bg-linear-to-r from-violet-600 to-fuchsia-700 text-transparent">
